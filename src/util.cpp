...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Pure
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Pure
    // Mac: ~/Library/Application Support/Pure
    // Unix: ~/.pure
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Pure";
#else
    fs::path pathRet;
