...
private slots:
    ...
    QString BuyPURE(QString OrderType, double Quantity, double Rate);
    QString SellPURE(QString OrderType, double Quantity, double Rate);
