...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: pure.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: pured.pid)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizepureamount=<n> " + _("Keep N Pure anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    LogPrintf("Anonymize Pure Amount %d\n", nAnonymizePureAmount);

    /* Denominations
       A note about convertability. Within Darksend pools, each denomination
       is convertable to another.
       For example:
       1PURE+1000 == (.1PURE+100)*10
       10PURE+10000 == (1PURE+1000)*10
    */
